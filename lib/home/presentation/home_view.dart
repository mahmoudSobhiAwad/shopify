...
import 'package:shopify/home/presentation/widgets/custom_app_bar.dart';
import 'package:shopify/home/presentation/widgets/home_body.dart';
...
class _HomeViewState extends State<HomeView> {
  ...
  List<ProductModel> productInPageView =
      mainProudcts.where((item) => item.productImage != null).toList(); // get the images to be shown in page view , and ensure all products that has image
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: const CustomAppBar(), // using sized widget to make a separate widget 
        body: HomeBody(
          changeState: () {
